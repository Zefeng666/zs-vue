...
const config = {
  request: (opt) => {
    ...
    // axios.defaults.headers.common['Authorization'] = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NDA1NjI3OTUsInVzZXJuYW1lIjoi5pyI6ZOt5rO9In0.0rPCAav8xbTvyZs24ABVa144xbQuTFxNxBmfPh5QvtU';
