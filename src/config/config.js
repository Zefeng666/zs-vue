...
const config = {
  request: (opt) => {
    ...
    axios.defaults.headers.common['Authorization'] = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1Mzg4MzEyMDksInVzZXJuYW1lIjoib2FrIn0.qyYziTJ4817IsOnTUowfKviJnW8abHhwN7fOC86HFUQ';
