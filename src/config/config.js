...
const config = {
  request: (opt) => {
    ...
    // axios.defaults.headers.common['Authorization'] = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1Mzk5NDEwNzgsInVzZXJuYW1lIjoi5b635LqR56eR5oqAIn0.uL55cj9f7HZzsQ6H4okGXQKtEq7zNHmg3w6TOkFJxMI';
