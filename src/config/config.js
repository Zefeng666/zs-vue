...
const config = {
  request: (opt) => {
    ...
    // axios.defaults.headers.common['Authorization'] = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NDA3MTAyNDIsInVzZXJuYW1lIjoi5pyI6ZOt5rO98J-UhSJ9.DimCaWRYwbpAc6rQmZpOtIn3uCQcWtDBvjmb8cbue8s';
